...
! function() {
	...
	r.prototype.fetch = function(e) {
		function t(t) {
			...
			var l = Math.floor(e / a) * a + r * o;/*��ǰʱ������ʼ������*/
		...
		var r = Math.floor(e / o % 24);/*��ǰ������,����ʱ��*/
		this.next_fetch_time = (1 + Math.floor(e / o)) * o; /*��һ�㿪ʼ�ĺ�����*/
		var n = this,
...
! function() {
	...
	i.prototype.init_icons = function() {
		...
		t.prototype.draw = function() {
			gl.drawArrays(gl.LINES, this.offset, this.count)/*������״�⻷shape icon*/
		},
		GTW.systems_foreach(function(e) {
			var t = r(e.n_sides);
			o[e.id] = t
			...
			_.each(this.missiles, function(t) {
				if (t.alive && t.has_source /* && t.index == 0*/) {
					...
					if (2 > o) {
						...
						var a = 2 * g,
							i = a * t.index;
						gl.drawArrays(gl.TRIANGLE_STRIP, i, a)/*�켣*/
					}
				}
			})
		}
		if (gl.enable(gl.BLEND), gl.blendFunc(gl.SRC_ALPHA, gl.ONE), l.use_impacts && e.high_quality) {
			...
			_.each(this.missiles, function(t) {
				if (t.alive) {
					...
					/*if (t.index != 0) return;*/
					n.uniform3fv('color', t.color),
					t.has_source && t.draw_source_impact && 1 > o && (n.uniformMatrix4fv('mat', t.source_mat), n.uniform1f('time', o), gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4)),/*����Դ*/
					t.has_target && o >= 1 && (n.uniformMatrix4fv('mat', t.target_mat), n.uniform1f('time', (o - 1) / 3), gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4)/*����Ŀ��*/)
				}
			})
		}
		if (l.use_cones && e.high_quality) {
			...
			_.each(this.missiles, function(r) {
				if (r.alive/* && t.index == 0 */) {
					...
					r.has_target && o >= 1 && 2 > o && (n.uniform3fv('color', r.color), n.uniformMatrix4fv('mat', r.target_mat), n.uniform1f('time', o - 1), gl.drawArrays(gl.TRIANGLE_STRIP, 0, t.n_cone_verts)/*Բ׶����*/)
				}
			})
		}
		if (l.use_icons) {
...
function() {
	...
	GTW.Stars = function() {
		...
		return e.prototype.draw = function(e) {/*�������ǿ�*/
	...
	GTW.World = function() {
		...
		o.prototype.build_geometry = function(e) {
			...
			this.buffers.map.vert = webgl.makeVertexBuffer(new Float32Array(n)), /*���ұ����vertex buffer*/
			this.buffers.map.face = webgl.makeElementBuffer(new Uint16Array(s)),/*���ұ����index buffer*/
			this.buffers.map.line = webgl.makeElementBuffer(new Uint16Array(o.lines)),/*���ұ߽���vertex buffer*/
			...
			if (this.buffers.map.vert) {
				...
				if (o) {
					...
					_.each(this.countries, function(e, t) 
					{
						...
						l/*��lΪtrueʱ�����������ڵĴ���Ż�ִ��*/ && (f.uniform1f('offset_x', -20),
						/*gl.drawElements(gl.TRIANGLES, e.face_count, gl.UNSIGNED_SHORT, e.face_offset << 1),*//*��ƽ��ʱ�Ҳ��ͼÿ�����ҵĵ���*/
                        f.uniform1f('offset_x', 20),
						gl.drawElements(gl.TRIANGLES, e.face_count, gl.UNSIGNED_SHORT, e.face_offset << 1))/*��ƽ��ʱ���ÿ�����ҵĵ���*/
					}), gl.depthFunc(gl.LESS), i && (gl.disable(gl.CULL_FACE), f.uniform1f('tone', 0.5), f.uniform1f('offset_x', 0), 
					/*gl.drawElements(gl.TRIANGLES, this.coast_count, gl.UNSIGNED_SHORT, this.coast_start << 1),*//*�����ҵ�ģ�͵ĺ�Ȳ���*/ 
                    l/*��lΪtrueʱ�����������ڵĴ���Ż�ִ��*/ && (f.uniform1f('offset_x', -20),
					gl.drawElements(gl.TRIANGLES, this.coast_count, gl.UNSIGNED_SHORT, this.coast_start << 1)/*��ƽ��ʱ�Ҳ���ҵ�ģ�ͺ�Ȳ���*/, 
                    f.uniform1f('offset_x', 20),
					gl.drawElements(gl.TRIANGLES, this.coast_count, gl.UNSIGNED_SHORT, this.coast_start << 1)))/*��ƽ��ʱ�����ҵ�ģ�ͺ�Ȳ���*/, gl.enable(gl.BLEND), gl.blendFunc(gl.SRC_ALPHA, gl.ONE), gl.disable(gl.DEPTH_TEST), gl.enable(gl.CULL_FACE), e.pick_index >= 0) 
					{
						...
						/*,gl.drawElements(gl.TRIANGLES, p.face_count, gl.UNSIGNED_SHORT, p.face_offset << 1)*//*��ѡ�й��ҵĸ�������*/
					}
					gl.disable(gl.CULL_FACE)
				}/*�����Ҽ�߽�*/
				if (a) {/*
...
! function() {
	GTW.Labels = function() {
		...
		e.prototype.render_labels = function(e) {/*�ȴ���2048��С����ͼ��Ȼ�����label�����ݣ���������label������ͼatlas*/
		...
		e.prototype.project_labels = function(e) {/*��������label������*/
			function t(t, r, i, u) {
				mat4.identity(t);
				if ('ecef' == e)
				{
		...
		return e.prototype.draw = function(e) {
			if (0 != this.labels.length) {
				...
				gl.drawArrays(gl.TRIANGLES, 0, 6 * this.country_count),/*��Զ����ʱ�Ĺ�������*/
				a.uniform1i('inside', 1),
				gl.drawArrays(gl.TRIANGLES, 6 * this.country_count, 6 * this.city_count),/*��������ʱ�Ĺ�������*/
				gl.depthMask(!0),
				gl.disable(gl.BLEND)
			}
		},
...
/*��������������*/
	...
	function i() {
		...
		/*gl.drawElements(gl.TRIANGLE_STRIP, H, gl.UNSIGNED_SHORT, 0),*//*���ش���ʱ����*/
		...
		/*,gl.drawElements(gl.LINES, $, gl.UNSIGNED_SHORT, 0)*//*���߿�ʽ�Ĵ���ʱ���Σ��õ��ο���������*/
	}
...
GTW.init_demo = function(e, t) {
	...
	function n(t, r, n, o) {
		function a(e) {
			...
			t.vertexAttribPointer('position', 4, gl.FLOAT, !1, 0, 0),
			gl.drawArrays(gl.TRIANGLE_STRIP, 0, D),/*���������еĻ���*/
			gl.lineWidth(1),
			gl.enable(gl.BLEND),
			gl.blendFunc(gl.SRC_ALPHA, gl.ONE);
			var t = k.missile.use();
			...
			t.vertexAttribPointer('position', 4, gl.FLOAT, !1, 0, 0),
			gl.drawArrays(gl.TRIANGLE_STRIP, 0, S),/*�⻷�������ɫ*/
			gl.depthMask(!0),
			gl.disable(gl.BLEND),
			gl.disable(gl.DEPTH_TEST);
...
/*�������õ�ǰģʽ*/
	function o() {
		...
		} else if (e.demo_time < 15) 0 == g && (g = 1, e.flash(f), l.reset(), t.set_mode('scape'), e.draw_world = !1); /*���洩��ģʽ*/
...
GTW.init_marker = function(e) {
	...
	function r(e) {
		...
		,gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4)/*����ǰ������λ��*/
	}
	var n = [
		0,
		0,
...
MAP.init = function(e) {
	...
	function i() {
		if ('orbit' == z.camera_mode) {
			...
			var r = z.projection.dir > 0,/*-1 mercator ƽ��  1 ecef ����*/
				n = z.geocam.coord,
