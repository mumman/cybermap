function make_event_emitter(e) {
	...
	function f(e, t, r) {
		...
		for (var n = -1, o = r - t || 0, a = Array(0 > o ? 0 : o); ++n < o;) a[n] = e[t + n];
		return a
	}
	...
	function v(r) {
		...
		function H(e, t, r, n, o) {
			...
			t ? (n.push(e), o.push(a), (v ? Ke : cn)(e, function(e, i) {
				a[i] = H(e, t, r, n, o)
			}), p && (l(n), l(o)), a) : a
		}
		...
		function te(e, t, r, n, o, a) {
			...
			if (i = !0, o.push(e), a.push(t), p) {
				if (b = e.length, y = t.length, i = y == b, i || n)
					for (; y--;) {
						var T = b,
							w = t[y];
						if (n)
							for (; T-- && !(i = te(e[T], w, r, n, o, a)););
		...
		function ie(e, t, r, n, o, a) {
			...
			v[2] && (v[2] = f(v[2])),
			v[3] && (v[3] = f(v[3])), !i || 1 & v[1] || (v[4] = o), !i && 1 & v[1] && (t |= 8), !c || 4 & v[1] || (v[5] = a),
		...
		function Ce(e, t, r) {
			var n = {};
			if ('function' != typeof t)
				for (var o = -1, a = ee(arguments, !0, !1, 1), i = De(e) ? a.length : 0; ++o < i;) {
					var u = a[o];
					u in e && (n[u] = e[u])
				} else t = g.createCallback(t, r, 3),
			un(e, function(e, r, o) {
		...
		function qe(e) {
			for (var t = -1, r = Jr(e), n = r.length, o = pr(n); ++t < n;) o[t] = e[r[t]];
			return o
		}

		function Ve(e) {
			for (var t = arguments, r = -1, n = ee(t, !0, !1, 1), o = t[2] && t[2][t[1]] === e ? 1 : n.length, a = pr(o); ++r < o;) a[r] = e[n[r]];
			return a
		}
		...
		function Xe(e, t, r) {
			...
			Qr(e) ? i = o(e, t, r) > -1 : 'number' == typeof a ? i = (Ie(e) ? e.indexOf(t, r) : o(e, t, r)) > -1 : cn(e, function(e) {
		...
		function Ke(e, t, r) {
			var n = -1,
				o = e ? e.length : 0;
			if (t = t && 'undefined' == typeof r ? t : K(t, r, 3), 'number' == typeof o)
				for (; ++n < o && t(e[n], n, e) !== !1;);
			else cn(e, t);
			return e
		}
		...
		function Qe(e, t, r) {
			var n = e ? e.length : 0;
			if (t = t && 'undefined' == typeof r ? t : K(t, r, 3), 'number' == typeof n)
				for (; n-- && t(e[n], n, e) !== !1;);
			else {
				var o = Jr(e);
				n = o.length,
		...
		function Je(e, t, r) {
			var n = -1,
				o = e ? e.length : 0;
			if (t = g.createCallback(t, r, 3), 'number' == typeof o)
				for (var a = pr(o); ++n < o;) a[n] = t(e[n], n, e);
			else a = [],
			cn(e, function(e, r, o) {
				a[++n] = t(e, r, o)
			});
		...
		function et(e, t, r) {
			var o = -(1 / 0),
				a = o;
			if ('function' != typeof t && r && r[t] === e && (t = null), null == t && Qr(e))
		...
		function wt(e) {
			for (var t = arguments, r = 0, n = t.length, o = e ? e.length : 0; ++r < n;)
				for (var a = -1, i = t[r]; ++a < o;) e[a] === i && (Ur.call(e, a--, 1), o--);
			return e
		}
		...
		function Et(e, t, r) {
			...
			null == t && (t = e, e = 0);
			for (var n = -1, o = Vr(0, Pr((t - e) / (r || 1))), a = pr(o); ++n < o;) a[n] = e,
			e += r;
			return a
		}
		...
		function Nt() {
			...
			return function() {
				for (var t = arguments, r = e.length; r--;) t = [
					e[r].apply(this, t)
				];
				return t[0]
			}
		...
		function Wt(e, t, r) {
			...
			var h = function() {
				...
				m = function() {
					c && Lr(c),
					o = c = l = p, (v || f !== t) && (s = hn(), a = e.apply(u, n), c || o || (n = u = null))
				};
			return function() {
				...
				r && (d = !0, a = e.apply(u, n)), !d || c || o || (n = u = null),
				a
			}
		}
		...
		var Kr = Br ? function(e, t) {
			...
			on = function(e, t, r) {
				...
				for (; ++u < c;)
					if (o = i[u], o && z[typeof o])
						for (var s = -1, f = z[typeof o] && Jr(o), v = f ? f.length : 0; ++s < v;) n = f[s],
				a[n] = l ? l(a[n], o[n]) : o[n];
				return a
			},
			an = function(e, t, r) {
				...
				for (var i = arguments, u = 0, c = 'number' == typeof r ? 2 : i.length; ++u < c;)
					if (o = i[u], o && z[typeof o])
						for (var l = -1, s = z[typeof o] && Jr(o), f = s ? s.length : 0; ++l < f;) n = s[l],
...
function(e) {
	...
	function o(e) {
		...
		} else if (n(e), u.filter.call(this, e) && r in y)
			for (l = p(), i = 0; i < y[r].length; i++)
				if (o = y[r][i], o.scope == l || 'all' == o.scope) {
					c = o.mods.length > 0;
					for (a in T)(!T[a] && t(o.mods, +a) > -1 || T[a] && -1 == t(o.mods, +a)) && (c = !1);
	...
	function g(e) {
		var t,
			...
			n;
		for (t in y)
			for (r = y[t], n = 0; n < r.length;) r[n].scope === e ? r.splice(n, 1) : n++
	}
	...
	function(e) {
		...
		p.rotationTo = function() {
			...
			return function(n, o, a) {
				var i = u.dot(o, a);
				return -0.999999 > i ? (u.cross(e, t, o), u.length(e) < 0.000001 && u.cross(e, r, o), u.normalize(e, e), p.setAxisAngle(n, e, Math.PI), n) : i > 0.999999 ? (n[0] = 0, n[1] = 0, n[2] = 0, n[3] = 1, n) : (u.cross(e, o, a), n[0] = e[0], n[1] = e[1], n[2] = e[2], n[3] = 1 + i, p.normalize(n, n))
			}
		}(),
		p.setAxes = function() {
			var e = f.create();
		...
		p.slerp = function(e, t, r, n) {
			...
			1 - a > 0.000001 ? (o = Math.acos(a), i = Math.sin(o), u = Math.sin((1 - n) * o) / i, c = Math.sin(n * o) / i) : (u = 1 - n, c = n),
			e[0] = u * l + c * p,
			e[1] = u * s + c * g,
			e[2] = u * f + c * h,
			e[3] = u * v + c * m,
...
function(e) {
	...
	o.simplex3 = function(e, t, r) {
		...
		var W = 0.6 - A * A - M * M - R * R;
		0 > W ? o = 0 : (W *= W, o = W * W * I.dot3(A, M, R));
		var O = 0.6 - P * P - L * L - D * D;
		0 > O ? a = 0 : (O *= O, a = O * O * U.dot3(P, L, D));
		var C = 0.6 - S * S - F * F - k * k;
...
function() {
	...
	function c(e) {
		for (var t = 5381, r = e.length - 1; r >= 0; --r) t = (t << 5) + t + e.charCodeAt(r);
		return t
	}
	...
	function s(e, t) {
		for (var t = t || 1, r = [], n = 0; n < e.length; ++n) r.push(n);
		for (var o = vec3.create(), a = vec3.create(), i = 0, u = 1 / 0, c = vec3.create(), l = 0; t > l; ++l) {
			...
			for (var n = 0; n < r.length; ++n) {
				var s = r[n],
					f = e[s];
				if (0 !== n) {
					if (!(vec3.dist(o, f) < i) && (vec3.sub(c, o, f), vec3.normalize(c, c), vec3.scale(c, c, i), vec3.add(c, c, o), vec3.lerp(o, f, c, 0.5), i = 0.5 * vec3.dist(f, c), i > u)) break
				} else vec3.copy(o, f),
				i = 0
			}
	...
	function v(e) {
		return _.isUndefined(e.offsetX) ? [
			e.layerX,
			e.layerY
		] : [
			e.offsetX,
	...
	var p,
		...
		T = {
			decode: function(e, t) 
			{
				...
				o = new ArrayBuffer(n); 
				a = new Uint8Array(o);
				for ( i = 0; n > i; ++i) a[i] = r.charCodeAt(i);
				return t ? new t(o) : o
			},
			encode: function(e) {
	...
	p = this.performance && performance.now ? function() {
...
window.onGLSLError = function(e) {
	...
	switch (forEachLine(e.log, function(e, r) {
		...
		case 'COMPILE':
			...
			forEachLine(e.source, function(e, r) {
				var n = t[r + 1];
...
! function() {
	...
	e.prototype.update_quat = function(e, t, r) {
		if (this._update_projection(), mat4.fromRotationTranslation(n, t, e), mat4.invert(n, n), r)
			for (var o = n, a = this.view, i = r, u = 1 - r, c = 0; 16 > c; ++c) a[c] = i * a[c] + u * o[c];
...
! function() {
	function e(e) {
		var wtttt = MersenneTwister.random();
		return -e * Math.log(1 - wtttt)
	}
	...
	r.prototype.fetch = function(e) {
		function t(t) {
			...
			var l = Math.floor(e / a) * a + r * o;/*当前时间点的起始毫秒数*/
			...
			var strkeys = "";
			for (var ecnt = 0; ecnt < n.kevents.length; ++ecnt )
			{
				strkeys += n.kevents[ecnt].key + "#";
			};
		...
		var r = Math.floor(e / o % 24);/*当前几点钟,格林时间*/
		this.next_fetch_time = (1 + Math.floor(e / o)) * o; /*下一点开始的毫秒数*/
		var n = this,
	...
	r.prototype.poll_events = function(e) {
		...
		var t = [];
		return _.each(this.kevents, function(r) {
...
! function() {
	...
	function i(e) {
		...
		this.buffers = {
			...
			icon: null,
			cone: null,
			quad: webgl.makeVertexBuffer(new Float32Array([0,
				0,
				1,
				0,
				0,
		...
		t.prototype.launch = function(e, t, c, s, f, v) {
			if (this.style = t, this.shape = n.shapes[this.style], this.color = GTW.systems[this.style].color[e.palette].f, this.has_source = !! s, this.start_time = e.time, this.alive = !0, this.has_source && vec3.copy(this.source_coord, s), vec3.copy(this.target_coord, c), this.has_source) {
				...
				for (var w = Math.cos(v), E = Math.sin(v), x = this.index * h, A = i, M = u, R = 0; g > R; ++R) {
					var P = R / (g - 1);
					vec3.lerp(M, s, c, P);
					var L = m * Math.sin(P * Math.PI) * 0.15;
					M[0] += E * L * y,
					M[1] += E * L * T,
					M[2] += w * L,
					e.project(A, M),
			...
			this.has_source ? this.source_coord[2] < 0.015 ? (r(this.source_mat, this.source_coord, f, e), this.draw_source_impact = !0) : this.draw_source_impact = !1 : l.ff_impacts && (this.start_time -= 1),
	...
	i.prototype.init_icons = function() {
		...
		function r(r) {/*每个system的shape*/
			...
			for (var u = 5, c = 0; u > c; ++c) {
				for (var l = 0, s = 0; r > s; ++s) e(l, c),
				e(l + i, c),
				l += i;
				a && (e(l, c), e(0, c)),
				31 == r && (l = 0.8, e(l, c), e(l + Math.PI, c))
			}
		...
		t.prototype.draw = function() {
			gl.drawArrays(gl.LINES, this.offset, this.count)/*各种形状光环shape icon*/
		},
		GTW.systems_foreach(function(e) {
			var t = r(e.n_sides);
			o[e.id] = t
	...
	i.prototype.draw = function(e) {
		...
		if (gl.enable(gl.DEPTH_TEST), gl.depthMask(!1), l.use_missiles) {
			...
			_.each(this.missiles, function(t) {
				if (t.alive && t.has_source /* && t.index == 0*/) {
					++r.curves;
					var o = e.time - t.start_time;
					if (2 > o) {
						n.uniform1f('time', 0.5 * o),
						n.uniform3fv('color', t.color);
						var a = 2 * g,
							i = a * t.index;
						gl.drawArrays(gl.TRIANGLE_STRIP, i, a)/*轨迹*/
					}
				}
			})
		}
		if (gl.enable(gl.BLEND), gl.blendFunc(gl.SRC_ALPHA, gl.ONE), l.use_impacts && e.high_quality) {
			...
			_.each(this.missiles, function(t) {
				if (t.alive) {
					...
					/*if (t.index != 0) return;*/
					n.uniform3fv('color', t.color),
					t.has_source && t.draw_source_impact && 1 > o && (n.uniformMatrix4fv('mat', t.source_mat), n.uniform1f('time', o), gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4)),/*攻击源*/
					t.has_target && o >= 1 && (n.uniformMatrix4fv('mat', t.target_mat), n.uniform1f('time', (o - 1) / 3), gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4)/*攻击目标*/)
				}
			})
		}
		if (l.use_cones && e.high_quality) {
			...
			_.each(this.missiles, function(r) {
				if (r.alive/* && t.index == 0 */) {
					...
					r.has_target && o >= 1 && 2 > o && (n.uniform3fv('color', r.color), n.uniformMatrix4fv('mat', r.target_mat), n.uniform1f('time', o - 1), gl.drawArrays(gl.TRIANGLE_STRIP, 0, t.n_cone_verts)/*圆锥光柱*/)
				}
			})
		}
		if (l.use_icons) {
...
function() {
	...
	GTW.Stars = function() {
		...
		return e.prototype.draw = function(e) {/*画背景星空*/
	...
	GTW.Corona = function() {
		...
		return e.prototype.draw = function(e, t) {
			...
			gl.enable(gl.BLEND),
				'dark' === e.palette ? (gl.blendFunc(gl.SRC_ALPHA, gl.ONE), r.uniform3f('color0', 0.07, 0.25, 0.16), r.uniform3f('color1', 0, 0, 0)) : (gl.blendFunc(gl.DST_COLOR, gl.ZERO), r.uniform3f('color0', 0.07, 0.25, 0.16), r.uniform3f('color1', 1, 1, 1)),
			webgl.bindVertexBuffer(this.buffers.vert),
	...
	GTW.World = function() {
			...
			GTW.load_resources({
				...
				e.geoip = function() {
					...
					var n = t.geoip.country,
						o = t.geoip.coord,
						a = _.find(e.countries, function(e) {
							return e.iso2 == n
						});
					return a ? {
						country: a,
		...
		o.prototype.build_geometry = function(e) {
			...
			for (var c = o.verts.length / 2, l = 0; c > l; ++l)
			 t(l, 0);
			...
			/*if (this.geoip)
				for (var h = this.geoip.country.borders, m = 65535, l = 0; l < h.length; ++l) {
					var d = h[l];
					if (65535 != d) {
						if (65535 != m) {
							var p = t(m, 0),
			...
			for (var _ = vec3.create(), b = vec3.create(), y = 14, l = 0; l < s.length; l += 3)
				for (var f = s[l + 0], v = s[l + 1], T = s[l + 2], w = 0; 2 > w; ++w) {
					for (var E = 6 * w, x = 0; 3 > x; ++x) _[x] = n[y * v + E + x] - n[y * f + E + x],
			...
			this.buffers.map.vert = webgl.makeVertexBuffer(new Float32Array(n)), /*国家表面的vertex buffer*/
			this.buffers.map.face = webgl.makeElementBuffer(new Uint16Array(s)),/*国家表面的index buffer*/
			this.buffers.map.line = webgl.makeElementBuffer(new Uint16Array(o.lines)),/*国家边界线vertex buffer*/
		...
		o.prototype.draw = function(e) {
			if (this.buffers.map.vert) {
				...
				if (r) {
					...
					f.uniform1f('blend', c),
						'dark' === e.palette ? (f.uniform3f('color0', 0.07, 0.09, 0.07), f.uniform3f('color1', 0.36, 0.41, 0.36)) : (f.uniform3f('color0', 0.93, 0.95, 0.93), f.uniform3f('color1', 0.42, 0.48, 0.42));
					...
					f.vertexAttribPointer('position2', 3, gl.FLOAT, !1, v, 12),
					f.vertexAttribPointer('texcoord', 2, gl.FLOAT, !1, v, 24),
					f.uniform4f('color', 1, 1, 1, 1),
					webgl.bindElementBuffer(this.buffers.grid.elem),
					f.uniform1f('offset_x', 0),
					gl.drawElements(gl.TRIANGLES, this.grid_elem_count, gl.UNSIGNED_SHORT, 0),/*画球面*/
				...
				if (o) {
					...
					if (webgl.bindVertexBuffer(this.buffers.map.vert), f.vertexAttribPointer('position', 3, gl.FLOAT, !1, v, 0), f.vertexAttribPointer('normal', 3, gl.FLOAT, !1, v, 12), f.vertexAttribPointer('position2', 3, gl.FLOAT, !1, v, 24), f.vertexAttribPointer('normal2', 3, gl.FLOAT, !1, v, 36), f.vertexAttribPointer('texcoord', 2, gl.FLOAT, !1, v, 48), f.uniform1f('alpha', 1), 'dark' === e.palette ? (f.uniform3f('color0', 0.1, 0.12, 0.11), f.uniform3f('color1', 0.2, 0.23, 0.21)) : (f.uniform3f('color0', 0.41, 0.61, 0.48), f.uniform3f('color1', 0.51, 0.69, 0.53)), gl.disable(gl.BLEND), gl.enable(gl.CULL_FACE), gl.cullFace(gl.BACK), gl.enable(gl.DEPTH_TEST), webgl.bindElementBuffer(this.buffers.map.face), 
					_.each(this.countries, function(e, t) 
					{
						...
						l/*当l为true时，后面括号内的代码才会执行*/ && (f.uniform1f('offset_x', -20),
						/*gl.drawElements(gl.TRIANGLES, e.face_count, gl.UNSIGNED_SHORT, e.face_offset << 1),*//*画平面时右侧地图每个国家的地面*/
                        f.uniform1f('offset_x', 20),
						gl.drawElements(gl.TRIANGLES, e.face_count, gl.UNSIGNED_SHORT, e.face_offset << 1))/*画平面时左侧每个国家的地面*/
					}), gl.depthFunc(gl.LESS), i && (gl.disable(gl.CULL_FACE), f.uniform1f('tone', 0.5), f.uniform1f('offset_x', 0), 
					/*gl.drawElements(gl.TRIANGLES, this.coast_count, gl.UNSIGNED_SHORT, this.coast_start << 1),*//*画国家的模型的厚度部分*/ 
                    l/*当l为true时，后面括号内的代码才会执行*/ && (f.uniform1f('offset_x', -20),
					gl.drawElements(gl.TRIANGLES, this.coast_count, gl.UNSIGNED_SHORT, this.coast_start << 1)/*画平面时右侧国家的模型厚度部分*/, 
                    f.uniform1f('offset_x', 20),
					gl.drawElements(gl.TRIANGLES, this.coast_count, gl.UNSIGNED_SHORT, this.coast_start << 1)))/*画平面时左侧国家的模型厚度部分*/, gl.enable(gl.BLEND), gl.blendFunc(gl.SRC_ALPHA, gl.ONE), gl.disable(gl.DEPTH_TEST), gl.enable(gl.CULL_FACE), e.pick_index >= 0) 
					{
						...
						/*,gl.drawElements(gl.TRIANGLES, p.face_count, gl.UNSIGNED_SHORT, p.face_offset << 1)*//*画选中国家的高亮表面*/
					}
					gl.disable(gl.CULL_FACE)
				}/*画国家间边界*/
				if (a) {/*
		...
		o.prototype.pick = function() {
			function e(e, a, i) {
				...
				gl.cullFace(gl.BACK),
				gl.enable(gl.DEPTH_TEST);
				var wtwt0 = gl.getParameter(gl.COLOR_ATTACHMENT0)
				var wtwt1 = gl.getParameter(gl.COLOR_ATTACHMENT1)
	...
	GTW.Labels = function() {
		...
		return e.prototype.draw = function(e) {
			if (0 != this.labels.length) {
				...
				gl.drawArrays(gl.TRIANGLES, 0, 6 * this.country_count),/*画远距离时的国家名字*/
				a.uniform1i('inside', 1),
				gl.drawArrays(gl.TRIANGLES, 6 * this.country_count, 6 * this.city_count),/*画近距离时的国家名字*/
				gl.depthMask(!0),
				gl.disable(gl.BLEND)
			}
		},
...
GTW.init_scape = function(e, t) {
	function r(e, t) {
		e += I[0],
		t += I[1];
		for (var r = 16, n = 0, o = 0.5; r--;) n += o * noise.perlin2(e, t),
		o *= 0.5,
		e *= 2,
		t *= 2;
		return n
	...
	function n(e) {
		return 0.5 + 0.5 * noise.perlin2(B * e + I[0], I[1])
	}
...
/*随机产生穿梭地形*/
	...
	function i() {
		vec3.lerp(ie, ie, ue, 0.05),
		vec3.lerp(ne, ne, oe, 0.05),
		vec3.lerp(ue, ue, ae, 0.05),
		vec3.lerp(oe, oe, re, 0.05);
		var t = Q.scape.use();
		...
		/*gl.drawElements(gl.TRIANGLE_STRIP, H, gl.UNSIGNED_SHORT, 0),*//*画地穿梭时地形*/
		gl.disable(gl.POLYGON_OFFSET_FILL),
		gl.enable(gl.BLEND),
		gl.blendFunc(gl.SRC_ALPHA, gl.ONE);
		var t = Q.scape_lines.use();
		t.uniformMatrix4fv('mvp', e.camera.mvp),
		t.uniform4f('color', 140 / 255, 160 / 255, 138 / 255, 0.5),
		webgl.bindVertexBuffer(Y.verts),
		t.vertexAttribPointer('position', 4, gl.FLOAT, !1, 0, 0),
		webgl.bindElementBuffer(Y.lines)
		/*,gl.drawElements(gl.LINES, $, gl.UNSIGNED_SHORT, 0)*//*画线框方式的穿梭时地形，让地形看起来高亮*/
	}
	...
	function s() {
		...
		fe += 1 / 60;
		var a = n(r);
		if (o(Z, r, a, 0), o(J, r + 0.01, a, 0), vec3.sub(le, J, Z), vec3.normalize(le, le), vec3.normalize(S, Z), o(Z, r, a), vec3.scaleAndAdd(Z, Z, S, 0.5), he ? (vec3.copy(ce, Z), g.move_to(ce, le, S), vec3.copy(p.pos, g.pos), vec3.copy(p.rot, g.rot), he = !1) : (vec3.lerp(ce, ce, Z, 0.1), g.move_to(ce, null, S), p.follow(g.pos, g.rot, 0.1, 0.05)), p.roll(0.01 * noise.perlin2(e.time, 0.934)), fe > ve) {
			ve = fe + u(pe);
			var i = l();
			if (Math.random() < 0.3) {
				var c = Z,
					...
					f = Math.random(),
					v = r + lerp(0.01, 0.2, f),
					h = n(v) + Random.gauss(0, 0.1);
				W(c, v, h);
				var m = t.launch(e, i, c, s);
				vec3.scaleAndAdd(ue, ue, m.color, 0.5 * f),
				vec3.scaleAndAdd(oe, oe, m.color, 0.5 * (1 - f)),
				0.1 > f && (e.flash(m.color), ge = 1)
			} else {
				var s = Z,
					c = J,
					v = Random.uniform(r + 0.2, 1),
					h = n(v) + Random.gauss(0, 0.1),
	...
	function f() {
		if (vec3.copy(Z, p.pos), e.camera.update_quat(Z, p.rot), ge > 0.001) {
			var t = 5 * e.time,
				n = 3 * Math.sin(Math.PI * ge);
			e.camera.mvp[12] += 0.2 * n * r(t, 0.3123123),
			e.camera.mvp[13] += 1.5 * n * (r(t, 0.9123123) - 0.125),
	...
	var v = function() {
		...
		return e.prototype.move_to = function(e, l, s) {
			if (vec3.copy(t, e), vec3.copy(r, this.pos), vec3.copy(o, this.tan), vec3.sub(n, t, r), vec3.normalize(n, n), quat.copy(i, this.rot), s) {
				...
				vec3.copy(c, s);
				var f = vec3.dot(u, c);
				0.999999 > f && (vec3.cross(a, u, c), a[3] = 1 + f, quat.normalize(a, a), quat.multiply(a, a, i), quat.dot(i, a) < 0 && quat.scale(a, a, -1)),
			...
			quat.rotationTo(this.rot, this.forward, this.tan);
				...
				var f = vec3.dot(o, n);
				0.999999 > f && (vec3.cross(a, o, n), a[3] = 1 + f, quat.normalize(a, a), quat.multiply(a, a, i), quat.dot(i, a) < 0 && quat.scale(a, a, -1)),
		...
		e.prototype.follow = function(e, t, r, n) {
			vec3.lerp(this.pos, this.pos, e, r || 0.05),
			vec4.lerp(this.rot, this.rot, t, n || 0.02),
	...
	for (var D = vec4.create(), S = vec3.create(), F = 3, k = Math.pow, G = Math.abs, I = vec2.create(), U = 2.5, N = 3, B = 2, W = function() {
			...
			return function(t, o, a, i) {
				...
				vec3.scaleAndAdd(e, e, R, 2 * (a - 0.5));
				var u = n(o),
					c = G(a - u),
					l = 0.05 + 0.95 * smoothstep(clamp(U * c, 0, 1)),
					s = i * (r(8 * F * o, F * a) + 1);
				l *= k(s, N),
				l -= 0.075,
				0 > l ? l = 0 : l *= 2;
				var f = 0.25 * (1 + noise.perlin2(8 * o, 1 * a)) + 0.05 * r(8 * o, a);
				l += f,
				e[2] = 0.5 * l,
				vec3.copy(t, e)
			}
	...
	var re = function() {
		var e = vec4.fromValues(0.1, 0.12, 0.11, 1),
			t = vec4.fromValues(0.2, 0.23, 0.21, 1),
			r = 0.1,
			n = vec4.create();
		...
		ne = vec4.clone(re),
		oe = vec4.clone(re),
		ae = vec3.fromValues(0.01, 0.05, 0.02),
		ie = vec3.clone(ae),
		ue = vec3.clone(ae),
		Z = vec3.create(),
		J = vec3.create(),
...
GTW.init_demo = function(e, t) {
	...
	function n(t, r, n, o) {
		function a(e) {
			...
			t.vertexAttribPointer('position', 4, gl.FLOAT, !1, 0, 0),
			gl.drawArrays(gl.TRIANGLE_STRIP, 0, D),/*画跟随光飞行的环形*/
			gl.lineWidth(1),
			gl.enable(gl.BLEND),
			gl.blendFunc(gl.SRC_ALPHA, gl.ONE);
			var t = k.missile.use();
			...
			t.vertexAttribPointer('position', 4, gl.FLOAT, !1, 0, 0),
			gl.drawArrays(gl.TRIANGLE_STRIP, 0, S),/*光环穿梭的颜色*/
			gl.depthMask(!0),
			gl.disable(gl.BLEND),
			gl.disable(gl.DEPTH_TEST);
		...
		for (var t = vec3.clone(t), r = vec3.clone(r), i = vec2.distance(t, r), u = 0.005 * i, c = vec3.create(), l = vec3.create(), s = 0, f = c, g = l, h = 103, m = new Float32Array(4 * h * 8), d = 0; h > d; ++d) {
			var _ = d / (h - 1);
			vec3.lerp(g, t, r, _);
			var b = u * Math.sin(_ * Math.PI) * 0.85;
			g[2] += b,
			e.project(f, g),
			vec3.save(f, m, s + 0),
			m[s + 3] = -_,
		...
		! function() {
			...
			for (var a = 0; a < M.length; ++a)
				for (var i = M[a], u = M[a + 1], c = a / (h - 1), l = lerp(0.02, 0.07, c), s = (n ? Math.PI : TWO_PI) / o, f = 0, v = 0.00015 / l, p = 0; o >= p; ++p) {
					var g = a && !p;
					n && p == o && (f = 0),
					g && t(L),
					e(L, i, f, l - v, -c),
...
/*更新设置当前模式*/
	function o() {
		...
		if (e.demo_time < 5) {/*导弹飞行模式*/
		...
		} else if (e.demo_time < 15) 0 == g && (g = 1, e.flash(f), l.reset(), t.set_mode('scape'), e.draw_world = !1); /*地面穿梭模式*/
			...
			return n.follow(r.pos, r.rot, 0.00005 + 0.5 * Math.pow(a, 3), 0.2),
...
GTW.init_hedgehog = function(e) {
	function t() {
		...
		var e = 2;
		this.scale = vec2.fromValues(1 * e, 0.25 * e),
		this.texture = null
	}
	...
	function r(e, r) {
		...
		for (var n = [], o = 0; 10 > o; ++o) {
			...
			if (i) {
				...
				window.lang ? v.fillText(window.lang.getText('NUMBER_SYMBOL') + u + ' ' + window.lang.getText('MOST_ATTACKED_COUNTRY'), 30, 90) : 'ru' == d ? v.fillText('??' + u + ' ?? ?????? ???? ???????? ??????', 30, 90) : v.fillText('#' + u + ' MOST-ATTACKED COUNTRY', 30, 90);
...
GTW.init_marker = function(e) {
	...
	function r(e) {
		if (!v) {
			...
			vec3.lerp(c, s, l, Math.pow(f, 0.75))
		}
		gl.enable(gl.DEPTH_TEST),
		gl.enable(gl.BLEND),
...
MAP.init = function(e) {
	...
	function r(e, t) {
		if (ye.clear(), e && t) {
			var r = e.getBoundingClientRect(),
				...
				o = r.left + 0.5 * r.width,
				a = r.top + 0.5 * r.height;
			o -= n.left,
			a -= n.top;
			var i = vec3.create();
			i[0] = 2 * (o / X.width - 0.5),
			i[1] = -2 * (a / X.height - 0.5);
			var u = vec3.create(),
				c = vec3.create(),
				l = {
					NO: [
	...
	function i() {
		if ('orbit' == z.camera_mode) {
			...
			var r = z.projection.dir > 0,/*-1 mercator 平面  1 ecef 球面*/
				n = z.geocam.coord,
	...
	function l() {
		...
		GTW.systems_foreach(function(e) {
			if (e.enabled_graph) {
				...
				oe.stroke(),
				se = clamp(lerp(se, 1.5 * u, 0.2), 50, 10000)
			}
		});
		for (var c = 0; n > c; c += o) {
			var i = (1 - c / n) * ie;
	...
	function p(e, t, r, n, o) {
		if (n)
		{
			...
			Re[1] = n[1];
			Re[2] = 0;
			if (he.geoip && t == he.geoip.country)
			{
			 (Re[2] += 0.014);
			}
			if ( r) 
			{
				...
				Pe[1] = n[3];
				Pe[2] = 0;
				if (he.geoip && r == he.geoip.country)
				{
					Re[2] += 0.014;
				}
		...
		else 
			{
				vec3.copy(Pe, Re);
				var a = o,
				i = 0.5 * lerp(5, 6, Math.random());
				Pe[0] += i * Math.cos(a);
				Pe[1] += i * Math.sin(a);
				Pe[2] += lerp(0.15, 0.2, Math.random());
				//ve.launch(z, e, Re, Pe);
			} 
		} 
		else
	...
	function g(e) {
		...
		if (he.countries.length) {
			...
			}), we = z.time + Random.uniform(0.1, 0.5))
		}
	}
	...
	function d() {
		if (z.time > Fe && m(ke), O || C) 
			return void(z.geocam.coord_delta[0] = 6 * z.dt);
		switch (Se) {
			case 'spin_1':
			case 'spin_2':
			case 'solo':
	...
	function T() {/*更新时间*//*帧开始*/
		...
		if (g(t), s(), W) {
			...
			var n = 'dark' === z.palette ? 0 : 0.9;
			gl.clearColor(n, n, n, 1),
			gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT),
			z.projection.blend > 0.5 && (pe.draw(z), z.draw_world ? ge.draw(z) : ge.draw(z, -1)),
	...
	function x() {
		X.addEventListener('DOMMouseScroll', function(e) {
			return e.wheelDelta = -120 * e.detail,
			Oe.mousewheel(e)
		}, !1),
		_.each(Oe, function(e, t) {
	...
	function A() {
		...
		var r = 0,
			...
			a = vec2.create(),
			i = vec2.create();
		X.addEventListener('touchstart', function(i) {
		...
		X.addEventListener('touchmove', function(o) {
			if ('drag' == n) {
				e(i, o);
				var u = i[0] - a[0],
					c = i[1] - a[1];
		...
		if (!MAP.is_bad_mode)
			if (e) {
				var t = GTW.systems[e],
					...
					n = {
						top: Math.round(0.7 * $(window).height()),
						left: Math.round(0.2 * $(window).width())
					},
				...
				c.beginPath(),
				o.left > n.left ? (c.moveTo(0.5, 0), c.lineTo(0.5, Math.floor(i / 2) + 0.5), c.lineTo(a - 0.5, Math.floor(i / 2) + 0.5), c.lineTo(a - 0.5, i)) : o.left < n.left ? (c.moveTo(a - 0.5, 0), c.lineTo(a - 0.5, Math.floor(i / 2) + 0.5), c.lineTo(0.5, Math.floor(i / 2) + 0.5), c.lineTo(0.5, i)) : (c.moveTo(0.5, 0), c.lineTo(0.5, i)),
				c.lineWidth = 1,
	...
	function S(e) {
		var e = _.filter(he.countries, function(t) {
			return Ve(t, 30) == e
		});
		return _.sample(e)
	}
	...
	function G() {
		if (N.got_country_data) {
			var e = {};
			_.each(he.countries, function(t) {
				e[t.key] = {
					key: t.key,
					name: t.name
				}
	...
	if (window.gl = webgl.setupCanvas(X, {
		...
		shaderSources: [
			GTW.SHADER_SOURCES || 'assets/map/shaders/all-shaders.glsl',
	...
	var z = {
		...
		project: function(e, t) {
			this.projection.blend < 0.5 ? GTW.project_mercator(e, t) : GTW.project_ecef(e, t)
		},
		projection: {
			blend: 1,
			dir: 1
	...
	var Oe = {/*鼠标事件*/
		...
		mousewheel: function(e) {
			...
			var t = 0.9,
				r = e.wheelDelta / 120;
			return 'orbit' == z.camera_mode ? z.orbit.translate[2] *= 0 > r ? t : 1 / t : 'geocam' == z.camera_mode && (z.geocam.coord_delta[2] -= 0.01 * r), !1
		}
	};
	if (O || C);
	else {
	...
	_.assign(MAP, {/*UI控制接口*/
		...
		set_language: function(e) {
			MAP.lang !== e && (MAP.lang = e, me.render_labels(e), me.project_labels(z.projection.blend < 0.5 ? 'mercator' : 'ecef'), be.setup(z, he))
		},
	...
	var Ve = function() {
		var e = vec3.create(),
			...
			r = vec3.create();
		return function(n, o) {
			if (z.projection.blend < 0.5) return !0;
		...
		Xe = !1;
	he.on('loaded', function() {
		function e() {
			var e = he.geoip;
			k(e.country, e.coord)
		}
		if (G(), !MAP.is_bad_mode)
			if (he.geoip) {
				setTimeout(e, 1000);
				var t = he.geoip;
