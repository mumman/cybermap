...
define(['shaders'], function(shaders){
    ...
    var position2=new THREE.BufferAttribute(new Float32Array(vertexCount*3), 3);
    ...
    for(var l=-widthSegments/2; widthSegments/2>=l; l++){
        ...
        for(var s=-heightSegments/2; heightSegments/2>=s; s++){
            ...
            position2.setXYZ(index, point1.x, point1.y, point1.z);
            uvs.setXY(index, u, v);
    ...
    geometry.addAttribute('normal', position2);
    geometry.addAttribute('position2', position2);
